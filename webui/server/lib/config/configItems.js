...
const configItems = [
  {
    ...
    default: '0.0.0.0',
    description:
      'IP address to bind to. By default, listening from all available addresses (0.0.0.0).'
  },
  {
    interface: 'env',
    key: 'port',
  ...
  },
  {
    ...
    default: '$HOME/birds/db',
    description:
      'Directory to store embedded database content. This includes queries, users, query result cache files, etc.'
  },
  {
    interface: 'env',
    key: 'baseUrl',
    ...
    uiDependency: true,
    description:
      "Path to mount birds app following domain. \nFor example, if '/birds' is provided, queries page \nwould be located at mydomain.com/birds/queries instead of mydomain.com/queries. \nUseful when subdomain is not an option."
  },
  {
    interface: 'env',
    key: 'passphrase',
  ...
  },
  {
    ...
    envVar: 'SQLPAD_DEBUG',
    default: false,
    description: 'Add a variety of logging to console while running'
  },
  {
    interface: 'env',
    key: 'googleClientId',
    ...
    sensitive: true,
    description:
      "Google Client ID used for OAuth setup. Note: authorized redirect URI is '[baseurl]/auth/google/callback'",
    default: ''
  },
  {
    interface: 'env',
    ...
    sensitive: true,
    description:
      "Google Client Secret used for OAuth setup. Note: authorized redirect URI is '[baseurl]/auth/google/callback'",
    default: ''
  },
  {
    interface: 'env',
  ...
  },
  {
    ...
    label: 'Allow CSV/XLSX/SQL Download',
    description: 'Set to false to disable csv, xlsx or sql downloads.',
    options: [true, false],
    uiDependency: true,
    default: true
  },
  {
    ...
    description: 'Set to true to enable word wrapping in editor.',
    options: [true, false],
    uiDependency: true,
    default: false
  },
  {
    ...
    key: 'showLineNumbers',
    label: 'Line Number',
    description: 'Set to true to enable line numbers in editor.',
    options: [true, false],
    uiDependency: true,
    default: false
  },
  {
    ...
    description: 'By default to font size of editor is 12pt.',
    default: 12,
    uiDependency: true
  }, 
  {
  ...
  },
  {
    ...
    options: [true, false],
    description:
      'If disabled, no longer poll npmjs.com to see if an update is available.',
    default: false
  }
];
