...
import DatalogEditor from './datalogEditor/DatalogEditor.js';
      ...
      <div className="flex w-100">
        <Switch>
          <Route
            exact
            path="/"
            render={() => <Redirect to={'/datalog/new'} />}
          />
          <Route
            exact
            path="/queries"
          ...
          <Route
            exact
            path="/datalog/:datalogId"
            render={({ match }) => (
              <Authenticated>
                <DatalogEditor datalogId={match.params.datalogId} />
              </Authenticated>
            )}
          />
          <Route
