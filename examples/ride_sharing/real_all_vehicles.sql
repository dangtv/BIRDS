...
WHERE __dummy__delta__insert__peer2_public_a6.col5 IS NOT DISTINCT FROM all_vehicles_med_a7_0.col6 AND __dummy__delta__insert__peer2_public_a6.col4 IS NOT DISTINCT FROM all_vehicles_med_a7_0.col5 AND __dummy__delta__insert__peer2_public_a6.col3 IS NOT DISTINCT FROM all_vehicles_med_a7_0.col4 AND __dummy__delta__insert__peer2_public_a6.col2 IS NOT DISTINCT FROM all_vehicles_med_a7_0.col3 AND __dummy__delta__insert__peer2_public_a6.col1 IS NOT DISTINCT FROM all_vehicles_med_a7_0.col2 AND __dummy__delta__insert__peer2_public_a6.col0 IS NOT DISTINCT FROM all_vehicles_med_a7_0.col1 ) ) AS all_vehicles_a7_0  ) AS __dummy__;
...
temprec__dummy__delta__insert__peer2_public public.peer2_public%ROWTYPE;
  BEGIN
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'all_vehicles_delta_action_flag') THEN
        ...
        CREATE TEMPORARY TABLE __dummy__delta__delete__peer1_public WITH OIDS ON COMMIT DROP AS SELECT (ROW(col0,col1,col2,col3,col4,col5) :: public.peer1_public).* 
            FROM (SELECT DISTINCT __dummy__delta__delete__peer1_public_a6_0.col0 AS col0, __dummy__delta__delete__peer1_public_a6_0.col1 AS col1, __dummy__delta__delete__peer1_public_a6_0.col2 AS col2, __dummy__delta__delete__peer1_public_a6_0.col3 AS col3, __dummy__delta__delete__peer1_public_a6_0.col4 AS col4, __dummy__delta__delete__peer1_public_a6_0.col5 AS col5 
...
WHERE NOT EXISTS ( SELECT * 
FROM (SELECT DISTINCT __temp__all_vehicles_a7_0.COMPANY_ID AS col0, __temp__all_vehicles_a7_0.VEHICLE_ID AS col1, __temp__all_vehicles_a7_0.CURRENT_AREA AS col2, __temp__all_vehicles_a7_0.SEAT_COUNT AS col3, __temp__all_vehicles_a7_0.REQUEST_ID AS col4, __temp__all_vehicles_a7_0.PICKUP_LOCATION AS col5, __temp__all_vehicles_a7_0.DROPOFF_LOCATION AS col6 
FROM __temp__all_vehicles AS __temp__all_vehicles_a7_0  ) AS all_vehicles_a7 
WHERE all_vehicles_a7.col6 IS NOT DISTINCT FROM peer1_public_a6_0.DROPOFF_LOCATION AND all_vehicles_a7.col5 IS NOT DISTINCT FROM peer1_public_a6_0.PICKUP_LOCATION AND all_vehicles_a7.col4 IS NOT DISTINCT FROM peer1_public_a6_0.REQUEST_ID AND all_vehicles_a7.col3 IS NOT DISTINCT FROM peer1_public_a6_0.SEAT_COUNT AND all_vehicles_a7.col2 IS NOT DISTINCT FROM peer1_public_a6_0.CURRENT_AREA AND all_vehicles_a7.col1 IS NOT DISTINCT FROM peer1_public_a6_0.VEHICLE_ID AND all_vehicles_a7.col0 IS NOT DISTINCT FROM 1 ) ) AS __dummy__delta__delete__peer1_public_a6_0  ) AS __dummy__delta__delete__peer1_public_extra_alias;

CREATE TEMPORARY TABLE __dummy__delta__delete__peer2_public WITH OIDS ON COMMIT DROP AS SELECT (ROW(col0,col1,col2,col3,col4,col5) :: public.peer2_public).* 
            FROM (SELECT DISTINCT __dummy__delta__delete__peer2_public_a6_0.col0 AS col0, __dummy__delta__delete__peer2_public_a6_0.col1 AS col1, __dummy__delta__delete__peer2_public_a6_0.col2 AS col2, __dummy__delta__delete__peer2_public_a6_0.col3 AS col3, __dummy__delta__delete__peer2_public_a6_0.col4 AS col4, __dummy__delta__delete__peer2_public_a6_0.col5 AS col5 
...
FROM (SELECT DISTINCT __temp__all_vehicles_a7_0.COMPANY_ID AS col0, __temp__all_vehicles_a7_0.VEHICLE_ID AS col1, __temp__all_vehicles_a7_0.CURRENT_AREA AS col2, __temp__all_vehicles_a7_0.SEAT_COUNT AS col3, __temp__all_vehicles_a7_0.REQUEST_ID AS col4, __temp__all_vehicles_a7_0.PICKUP_LOCATION AS col5, __temp__all_vehicles_a7_0.DROPOFF_LOCATION AS col6 
FROM __temp__all_vehicles AS __temp__all_vehicles_a7_0  ) AS all_vehicles_a7 
WHERE all_vehicles_a7.col6 IS NOT DISTINCT FROM peer2_public_a6_0.DROPOFF_LOCATION AND all_vehicles_a7.col5 IS NOT DISTINCT FROM peer2_public_a6_0.PICKUP_LOCATION AND all_vehicles_a7.col4 IS NOT DISTINCT FROM peer2_public_a6_0.REQUEST_ID AND all_vehicles_a7.col3 IS NOT DISTINCT FROM peer2_public_a6_0.SEAT_COUNT AND all_vehicles_a7.col2 IS NOT DISTINCT FROM peer2_public_a6_0.CURRENT_AREA AND all_vehicles_a7.col1 IS NOT DISTINCT FROM peer2_public_a6_0.VEHICLE_ID AND all_vehicles_a7.col0 IS NOT DISTINCT FROM 2 ) ) AS __dummy__delta__delete__peer2_public_a6_0  ) AS __dummy__delta__delete__peer2_public_extra_alias;

CREATE TEMPORARY TABLE __dummy__delta__insert__peer1_public WITH OIDS ON COMMIT DROP AS SELECT (ROW(col0,col1,col2,col3,col4,col5) :: public.peer1_public).* 
            FROM (SELECT DISTINCT __dummy__delta__insert__peer1_public_a6_0.col0 AS col0, __dummy__delta__insert__peer1_public_a6_0.col1 AS col1, __dummy__delta__insert__peer1_public_a6_0.col2 AS col2, __dummy__delta__insert__peer1_public_a6_0.col3 AS col3, __dummy__delta__insert__peer1_public_a6_0.col4 AS col4, __dummy__delta__insert__peer1_public_a6_0.col5 AS col5 
...
FOR temprec__dummy__delta__delete__peer2_public IN ( SELECT * FROM __dummy__delta__delete__peer2_public) LOOP 
            DELETE FROM public.peer2_public WHERE ROW(VEHICLE_ID,CURRENT_AREA,SEAT_COUNT,REQUEST_ID,PICKUP_LOCATION,DROPOFF_LOCATION) IS NOT DISTINCT FROM  temprec__dummy__delta__delete__peer2_public;
            END LOOP;
...
AS $$
  ...
  BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
      DELETE FROM __temp__all_vehicles WHERE ROW(COMPANY_ID,VEHICLE_ID,CURRENT_AREA,SEAT_COUNT,REQUEST_ID,PICKUP_LOCATION,DROPOFF_LOCATION) IS NOT DISTINCT FROM OLD;
      INSERT INTO __temp__all_vehicles SELECT (NEW).*; 
