...
CREATE OR REPLACE VIEW public.peer2_public AS SELECT __dummy__.col0 AS VEHICLE_ID,__dummy__.col1 AS CURRENT_AREA,__dummy__.col2 AS SEAT_COUNT,__dummy__.col3 AS REQUEST_ID,__dummy__.col4 AS PICKUP_LOCATION,__dummy__.col5 AS DROPOFF_LOCATION FROM (SELECT peer2_public_a6_0.col0 AS col0, peer2_public_a6_0.col1 AS col1, peer2_public_a6_0.col2 AS col2, peer2_public_a6_0.col3 AS col3, peer2_public_a6_0.col4 AS col4, peer2_public_a6_0.col5 AS col5 FROM (SELECT peer2_public_med_a6_0.col0 AS col0, peer2_public_med_a6_0.col1 AS col1, peer2_public_med_a6_0.col2 AS col2, peer2_public_med_a6_0.col3 AS col3, peer2_public_med_a6_0.col4 AS col4, peer2_public_med_a6_0.col5 AS col5 FROM (SELECT peer2_vehicle_a6_0.VEHICLE_ID AS col0, area_a2_1.AREA_NODE AS col1, peer2_vehicle_a6_0.SEAT_COUNT AS col2, peer2_vehicle_a6_0.REQUEST_ID AS col3, peer2_vehicle_a6_0.PICKUP_LOCATION AS col4, peer2_vehicle_a6_0.DROPOFF_LOCATION AS col5 FROM public.peer2_vehicle AS peer2_vehicle_a6_0, public.area AS area_a2_1 WHERE area_a2_1.ORIGINAL_NODE = peer2_vehicle_a6_0.CURRENT_LOCATION ) AS peer2_public_med_a6_0 WHERE NOT EXISTS ( SELECT * FROM (SELECT peer2_vehicle_a6_1.VEHICLE_ID AS col0, area_a2_2.ORIGINAL_NODE AS col1, peer2_public_med_a6_0.col2 AS col2, peer2_public_med_a6_0.col3 AS col3, peer2_public_med_a6_0.col4 AS col4, peer2_public_med_a6_0.col5 AS col5 FROM (SELECT peer2_vehicle_a6_0.VEHICLE_ID AS col0, area_a2_1.AREA_NODE AS col1, peer2_vehicle_a6_0.SEAT_COUNT AS col2, peer2_vehicle_a6_0.REQUEST_ID AS col3, peer2_vehicle_a6_0.PICKUP_LOCATION AS col4, peer2_vehicle_a6_0.DROPOFF_LOCATION AS col5 FROM public.peer2_vehicle AS peer2_vehicle_a6_0, public.area AS area_a2_1 WHERE area_a2_1.ORIGINAL_NODE = peer2_vehicle_a6_0.CURRENT_LOCATION ) AS peer2_public_med_a6_0, public.peer2_vehicle AS peer2_vehicle_a6_1, public.area AS area_a2_2 WHERE peer2_vehicle_a6_1.VEHICLE_ID = peer2_public_med_a6_0.col0 AND area_a2_2.ORIGINAL_NODE = peer2_vehicle_a6_1.CURRENT_LOCATION AND area_a2_2.AREA_NODE = peer2_public_med_a6_0.col1 AND NOT EXISTS ( SELECT * FROM public.peer2_vehicle AS peer2_vehicle_a6 WHERE peer2_vehicle_a6.DROPOFF_LOCATION IS NOT DISTINCT FROM peer2_public_med_a6_0.col5 AND peer2_vehicle_a6.PICKUP_LOCATION IS NOT DISTINCT FROM peer2_public_med_a6_0.col4 AND peer2_vehicle_a6.REQUEST_ID IS NOT DISTINCT FROM peer2_public_med_a6_0.col3 AND peer2_vehicle_a6.SEAT_COUNT IS NOT DISTINCT FROM peer2_public_med_a6_0.col2 AND peer2_vehicle_a6.CURRENT_LOCATION IS NOT DISTINCT FROM area_a2_2.ORIGINAL_NODE AND peer2_vehicle_a6.VEHICLE_ID IS NOT DISTINCT FROM peer2_vehicle_a6_1.VEHICLE_ID ) ) AS __dummy__delta__insert__peer2_vehicle_a6 WHERE __dummy__delta__insert__peer2_vehicle_a6.col5 IS NOT DISTINCT FROM peer2_public_med_a6_0.col5 AND __dummy__delta__insert__peer2_vehicle_a6.col4 IS NOT DISTINCT FROM peer2_public_med_a6_0.col4 AND __dummy__delta__insert__peer2_vehicle_a6.col3 IS NOT DISTINCT FROM peer2_public_med_a6_0.col3 AND __dummy__delta__insert__peer2_vehicle_a6.col2 IS NOT DISTINCT FROM peer2_public_med_a6_0.col2 AND __dummy__delta__insert__peer2_vehicle_a6.col0 IS NOT DISTINCT FROM peer2_public_med_a6_0.col0 ) ) AS peer2_public_a6_0  ) AS __dummy__;
...
AS $$
  ...
  BEGIN
    ...
    ELSIF TG_OP = 'DELETE' THEN
      DELETE FROM __temp__peer2_public WHERE (VEHICLE_ID,CURRENT_AREA,SEAT_COUNT,REQUEST_ID,PICKUP_LOCATION,DROPOFF_LOCATION) = OLD;
    END IF;
    CREATE TEMPORARY TABLE __dummy__delta__delete__peer2_vehicle WITH OIDS ON COMMIT DROP AS SELECT __dummy__delta__delete__peer2_vehicle_a6_0.col0 AS col0, __dummy__delta__delete__peer2_vehicle_a6_0.col1 AS col1, __dummy__delta__delete__peer2_vehicle_a6_0.col2 AS col2, __dummy__delta__delete__peer2_vehicle_a6_0.col3 AS col3, __dummy__delta__delete__peer2_vehicle_a6_0.col4 AS col4, __dummy__delta__delete__peer2_vehicle_a6_0.col5 AS col5 FROM (SELECT peer2_vehicle_a6_0.VEHICLE_ID AS col0, area_a2_1.ORIGINAL_NODE AS col1, peer2_vehicle_a6_0.SEAT_COUNT AS col2, peer2_vehicle_a6_0.REQUEST_ID AS col3, peer2_vehicle_a6_0.PICKUP_LOCATION AS col4, peer2_vehicle_a6_0.DROPOFF_LOCATION AS col5 FROM public.peer2_vehicle AS peer2_vehicle_a6_0, public.area AS area_a2_1 WHERE area_a2_1.ORIGINAL_NODE = peer2_vehicle_a6_0.CURRENT_LOCATION AND NOT EXISTS ( SELECT * FROM (SELECT __temp__peer2_public_a6_0.VEHICLE_ID AS col0, __temp__peer2_public_a6_0.CURRENT_AREA AS col1, __temp__peer2_public_a6_0.SEAT_COUNT AS col2, __temp__peer2_public_a6_0.REQUEST_ID AS col3, __temp__peer2_public_a6_0.PICKUP_LOCATION AS col4, __temp__peer2_public_a6_0.DROPOFF_LOCATION AS col5 FROM __temp__peer2_public AS __temp__peer2_public_a6_0  ) AS peer2_public_a6 WHERE peer2_public_a6.col5 IS NOT DISTINCT FROM peer2_vehicle_a6_0.DROPOFF_LOCATION AND peer2_public_a6.col4 IS NOT DISTINCT FROM peer2_vehicle_a6_0.PICKUP_LOCATION AND peer2_public_a6.col3 IS NOT DISTINCT FROM peer2_vehicle_a6_0.REQUEST_ID AND peer2_public_a6.col2 IS NOT DISTINCT FROM peer2_vehicle_a6_0.SEAT_COUNT AND peer2_public_a6.col1 IS NOT DISTINCT FROM area_a2_1.AREA_NODE AND peer2_public_a6.col0 IS NOT DISTINCT FROM peer2_vehicle_a6_0.VEHICLE_ID ) ) AS __dummy__delta__delete__peer2_vehicle_a6_0  ;
CREATE TEMPORARY TABLE __dummy__delta__insert__peer2_vehicle WITH OIDS ON COMMIT DROP AS SELECT __dummy__delta__insert__peer2_vehicle_a6_0.col0 AS col0, __dummy__delta__insert__peer2_vehicle_a6_0.col1 AS col1, __dummy__delta__insert__peer2_vehicle_a6_0.col2 AS col2, __dummy__delta__insert__peer2_vehicle_a6_0.col3 AS col3, __dummy__delta__insert__peer2_vehicle_a6_0.col4 AS col4, __dummy__delta__insert__peer2_vehicle_a6_0.col5 AS col5 FROM (SELECT peer2_vehicle_a6_1.VEHICLE_ID AS col0, area_a2_2.ORIGINAL_NODE AS col1, peer2_public_a6_0.col2 AS col2, peer2_public_a6_0.col3 AS col3, peer2_public_a6_0.col4 AS col4, peer2_public_a6_0.col5 AS col5 FROM (SELECT __temp__peer2_public_a6_0.VEHICLE_ID AS col0, __temp__peer2_public_a6_0.CURRENT_AREA AS col1, __temp__peer2_public_a6_0.SEAT_COUNT AS col2, __temp__peer2_public_a6_0.REQUEST_ID AS col3, __temp__peer2_public_a6_0.PICKUP_LOCATION AS col4, __temp__peer2_public_a6_0.DROPOFF_LOCATION AS col5 FROM __temp__peer2_public AS __temp__peer2_public_a6_0  ) AS peer2_public_a6_0, public.peer2_vehicle AS peer2_vehicle_a6_1, public.area AS area_a2_2 WHERE peer2_vehicle_a6_1.VEHICLE_ID = peer2_public_a6_0.col0 AND area_a2_2.ORIGINAL_NODE = peer2_vehicle_a6_1.CURRENT_LOCATION AND area_a2_2.AREA_NODE = peer2_public_a6_0.col1 AND NOT EXISTS ( SELECT * FROM public.peer2_vehicle AS peer2_vehicle_a6 WHERE peer2_vehicle_a6.DROPOFF_LOCATION IS NOT DISTINCT FROM peer2_public_a6_0.col5 AND peer2_vehicle_a6.PICKUP_LOCATION IS NOT DISTINCT FROM peer2_public_a6_0.col4 AND peer2_vehicle_a6.REQUEST_ID IS NOT DISTINCT FROM peer2_public_a6_0.col3 AND peer2_vehicle_a6.SEAT_COUNT IS NOT DISTINCT FROM peer2_public_a6_0.col2 AND peer2_vehicle_a6.CURRENT_LOCATION IS NOT DISTINCT FROM area_a2_2.ORIGINAL_NODE AND peer2_vehicle_a6.VEHICLE_ID IS NOT DISTINCT FROM peer2_vehicle_a6_1.VEHICLE_ID ) ) AS __dummy__delta__insert__peer2_vehicle_a6_0  ; 
...
INSERT INTO public.peer2_vehicle SELECT * FROM __dummy__delta__insert__peer2_vehicle;
  ...
  EXCEPTION
    WHEN object_not_in_prerequisite_state THEN
        RAISE object_not_in_prerequisite_state USING MESSAGE = 'no permission to insert or update or delete from public.peer2_public';
    WHEN OTHERS THEN
