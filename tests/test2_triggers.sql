...
AS $$
  ...
  BEGIN
    ...
    ELSIF TG_OP = 'DELETE' THEN
      DELETE FROM __temp__tracks3 WHERE (TRACK,RATING,ALBUM,QUANTITY) = OLD;
    END IF;
     FOR temprec IN (SELECT __dummy__delta__delete__tracks2_a4_0.col0 AS col0, __dummy__delta__delete__tracks2_a4_0.col1 AS col1, __dummy__delta__delete__tracks2_a4_0.col2 AS col2, __dummy__delta__delete__tracks2_a4_0.col3 AS col3 FROM (SELECT tracks2_a4_0.TRACK AS col0, tracks2_a4_0.RATING AS col1, tracks2_a4_0.ALBUM AS col2, tracks2_a4_0.QUANTITY AS col3 FROM public.tracks2 AS tracks2_a4_0 WHERE tracks2_a4_0.QUANTITY > 2 AND NOT EXISTS ( SELECT * FROM (SELECT __temp__tracks3_a4_0.TRACK AS col0, __temp__tracks3_a4_0.RATING AS col1, __temp__tracks3_a4_0.ALBUM AS col2, __temp__tracks3_a4_0.QUANTITY AS col3 FROM __temp__tracks3 AS __temp__tracks3_a4_0  ) AS tracks3_a4 WHERE tracks3_a4.col3 = tracks2_a4_0.QUANTITY AND tracks3_a4.col2 = tracks2_a4_0.ALBUM AND tracks3_a4.col1 = tracks2_a4_0.RATING AND tracks3_a4.col0 = tracks2_a4_0.TRACK ) ) AS __dummy__delta__delete__tracks2_a4_0  ) LOOP 
        DELETE FROM public.tracks2 WHERE (TRACK,RATING,ALBUM,QUANTITY)= (temprec.col0,temprec.col1,temprec.col2,temprec.col3);
        END LOOP;
INSERT INTO public.tracks2 SELECT __dummy__delta__delete__tracks2_a4_0.col0 AS col0, __dummy__delta__delete__tracks2_a4_0.col1 AS col1, __dummy__delta__delete__tracks2_a4_0.col2 AS col2, __dummy__delta__delete__tracks2_a4_0.col3 AS col3 FROM (SELECT tracks2_a4_0.TRACK AS col0, tracks2_a4_0.RATING AS col1, tracks2_a4_0.ALBUM AS col2, tracks2_a4_0.QUANTITY AS col3 FROM public.tracks2 AS tracks2_a4_0 WHERE tracks2_a4_0.QUANTITY > 2 AND NOT EXISTS ( SELECT * FROM (SELECT __temp__tracks3_a4_0.TRACK AS col0, __temp__tracks3_a4_0.RATING AS col1, __temp__tracks3_a4_0.ALBUM AS col2, __temp__tracks3_a4_0.QUANTITY AS col3 FROM __temp__tracks3 AS __temp__tracks3_a4_0  ) AS tracks3_a4 WHERE tracks3_a4.col3 = tracks2_a4_0.QUANTITY AND tracks3_a4.col2 = tracks2_a4_0.ALBUM AND tracks3_a4.col1 = tracks2_a4_0.RATING AND tracks3_a4.col0 = tracks2_a4_0.TRACK ) ) AS __dummy__delta__delete__tracks2_a4_0   UNION ALL SELECT __dummy__delta__insert__tracks2_a4_0.col0 AS col0, __dummy__delta__insert__tracks2_a4_0.col1 AS col1, __dummy__delta__insert__tracks2_a4_0.col2 AS col2, __dummy__delta__insert__tracks2_a4_0.col3 AS col3 FROM (SELECT tracks3_a4_0.col0 AS col0, tracks3_a4_0.col1 AS col1, tracks3_a4_0.col2 AS col2, tracks3_a4_0.col3 AS col3 FROM (SELECT __temp__tracks3_a4_0.TRACK AS col0, __temp__tracks3_a4_0.RATING AS col1, __temp__tracks3_a4_0.ALBUM AS col2, __temp__tracks3_a4_0.QUANTITY AS col3 FROM __temp__tracks3 AS __temp__tracks3_a4_0  ) AS tracks3_a4_0 WHERE tracks3_a4_0.col3 > 2 AND NOT EXISTS ( SELECT * FROM public.tracks2 AS tracks2_a4 WHERE tracks2_a4.QUANTITY = tracks3_a4_0.col3 AND tracks2_a4.ALBUM = tracks3_a4_0.col2 AND tracks2_a4.RATING = tracks3_a4_0.col1 AND tracks2_a4.TRACK = tracks3_a4_0.col0 ) ) AS __dummy__delta__insert__tracks2_a4_0  ;
    RETURN NULL;
  EXCEPTION
